...
{
    struct HarfbuzzLibrary *libBase = (struct HarfbuzzLibrary *)Self->Data.LibBase; 
...
STATIC struct Library *libInit(struct Library *LibraryBase, APTR seglist, struct Interface *exec)
{
    ...
    struct HarfbuzzLibrary *libBase = (struct HarfbuzzLibrary *)LibraryBase;
    ...
    libBase->libNode.lib_Node.ln_Name = "harfbuzz.library";
...
{
	{ CLT_DataSize,		sizeof(struct HarfbuzzLibrary)	},
